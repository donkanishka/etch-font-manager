...
class EFM_Builder {
	...
	protected static function strings() {
		return array(
			...
			'applyForceNone' => __( 'Adds !important to the Apply to rule. Fill in Apply to above to use it.', 'etch-font-manager' ),
			...
			'exportHeavy'    => __( 'Some of these families use TTF or OTF files. Converting them to WOFF2 first would normally cut that size by 40 to 65%.', 'etch-font-manager' ),
			...
			'importSending'  => __( 'Sending font files', 'etch-font-manager' ),
			...
			'cssPreviewUnsaved' => __( 'Save this family to see its generated CSS variable.', 'etch-font-manager' ),
			...
			'heavyLabel'     => __( 'Heavy format', 'etch-font-manager' ),
			'heavyNotice'    => __( 'This family loads TTF or OTF files. Converting them to WOFF2 keeps the glyphs, axes and features and is normally 40 to 65% smaller. Open Manage to convert them.', 'etch-font-manager' ),
			'heavyHint'      => __( 'These are desktop formats. WOFF2 keeps the glyphs, variable axes and OpenType features, normally at 40 to 65% of the size.', 'etch-font-manager' ),
			'heavyConvert'   => __( 'Convert to WOFF2', 'etch-font-manager' ),
			...
			'customVariableFix' => __( 'Fix the CSS variable for %s.', 'etch-font-manager' ),
			...
			'familyDetails'  => __( 'Family details', 'etch-font-manager' ),
			'familyName'     => __( 'Family name', 'etch-font-manager' ),
			'availability'   => __( 'Availability', 'etch-font-manager' ),
			...
			'metricsFailed'  => __( 'Could not read the metrics from this family\'s font.', 'etch-font-manager' ),
			...
			'uploadConversion' => __( 'WOFF2 conversion', 'etch-font-manager' ),
			'onLabel'        => __( 'On', 'etch-font-manager' ),
			'offLabel'       => __( 'Off', 'etch-font-manager' ),
			'uploadConversionOn' => __( 'TTF, OTF and WOFF convert before upload.', 'etch-font-manager' ),
			'uploadConversionOff' => __( 'Files upload in their original format.', 'etch-font-manager' ),
			...
			'failTooLarge'   => __( 'Your server refused this request because it is too large. Convert the fonts to WOFF2 to make them smaller, or export again without the font files included.', 'etch-font-manager' ),
			...
			'failUpload'     => __( 'Could not finish processing those fonts.', 'etch-font-manager' ),
			'failUploadFile' => __( 'Could not upload this file.', 'etch-font-manager' ),
			...
			'confirmFileDeleteDirty' => __( 'Deleting font files refreshes the library and settings from the server, which replaces anything unsaved in the panel.', 'etch-font-manager' ),
			'confirmInstallManyDirty' => __( 'Installing writes these families to the server, which replaces anything unsaved in the panel.', 'etch-font-manager' ),
			'confirmRecoverDirty' => __( 'Downloading writes these families to the server, which replaces anything unsaved in the panel.', 'etch-font-manager' ),
			'confirmRegenerateDirty' => __( 'Regenerating reloads the library and settings from the server, which replaces anything unsaved in the panel.', 'etch-font-manager' ),
			'cutsAllInstalled' => __( 'Every weight Google publishes for this family is installed.', 'etch-font-manager' ),
			'cutsUnchanged'  => __( 'Pick a weight this family does not have yet.', 'etch-font-manager' ),
