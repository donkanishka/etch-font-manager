...
* Tests: add three panel workflow regressions covering every guarded entry point, the save-then-run ordering and a refused save.
...
* Changed: the family editor heading now follows the name while typing and falls back to "New family" when the input is blank.
